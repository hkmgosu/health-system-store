(() => {
    ...
    /**
     * Example
     * <ssvq-storage-report-express-income-input></ssvq-storage-report-express-income-input>
     */
    app.directive('ssvqStorageReportExpressIncomeInput', function() {
        return {
            scope: {},
            ...
            restrict: 'E',
            templateUrl: '/components/storage/expressIncome/reportExpressIncomeInput/reportExpressIncomeInput.html'
        };
    });
    ...
    function ComponentController(companyFactory, unitFactory) {
        ...
        function getPdfEncab() {
            ...
            content.push({
                style: 'titlePage',
                text: "Detalle Recepción para Bodega de Farmacia\n\n"
            });
            ...
            if (vm.expressIncome.numInvoice) numInvoice = vm.expressIncome.numInvoice;
            ...
            if (vm.expressIncome.numPurchaseOrder) {
                numPurchaseOrder = vm.expressIncome.numPurchaseOrder + '/' + vm.expressIncome.yearPurchaseOrder;
            }
            ...
            if (!company && vm.expressIncome.donatedBy) company = vm.expressIncome.donatedBy;
        ...
        function generaPdf() {
            ...
            }).download("Productos Recibidos - Movimiento " + vm.expressIncome.id + ".pdf");
        }
    }
})();
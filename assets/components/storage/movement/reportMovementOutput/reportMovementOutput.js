(() => {
    ...
    /**
     * Example
     * <ssvq-storage-report-movement-output></ssvq-storage-report-movement-output>
     */
    app.directive('ssvqStorageReportMovementOutput', function() {
        return {
            scope: {},
            ...
            restrict: 'E',
            templateUrl: '/components/storage/movement/reportMovementOutput/reportMovementOutput.html'
        };
    });
    ...
    function ComponentController() {
        ...
        function generaPdf() {
            ...
            }).download("Productos Salientes - Movimiento " + vm.movement.id + ".pdf");
        }
    }
})();
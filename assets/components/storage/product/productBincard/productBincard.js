(function() {
    ...
    /**
     * Example
     * <ssvq-product-bincard key=""></ssvq-product-bincard>
     */
    app.directive('ssvqProductBincard', () => {
        return {
            ...
            restrict: 'E',
            scope: {},
            templateUrl: '/components/storage/product/productBincard/productBincard.html'
        };
    });
    ...
    function ComponentController($mdSidenav, $mdDialog, $mdToast, storageReportFactory, unitProductsManagerFactory) {
        ...
        vm.toggleFilter = () => {
            $mdSidenav('product-bincard-filter').toggle();
        };
        ...
        vm.showCreatedAtFilter = ($event) => {
            $mdDialog.show({
                targetEvent: $event,
                templateUrl: '/components/storage/product/productBincard/rangeDate.html',

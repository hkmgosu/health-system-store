(function() {
    ...
    /**
     * Example
     * <ssvq-product-stock key=""></ssvq-product-stock>
     */
    app.directive('ssvqProductStock', () => {
        return {
            ...
            restrict: 'E',
            scope: {},
            templateUrl: '/components/storage/product/productStock/productStock.html'
        };
    });
    ...
    function ComponentController($mdSidenav, $mdToast, storageReportFactory, productTypeFactory, unitProductsManagerFactory) {
        ...
        vm.filter = {
            codProduct: vm.product.productCode,
            productName: vm.product.description,
            product: vm.product.id,
            productType: vm.product.productType
        };

        vm.toggleFilter = () => {
            $mdSidenav('product-stock-filter').toggle();
        };
        ...
        vm.getArrayFilter = () => {
            ...
            arr[count++] = vm.getBodyFilter('Producto: ', vm.product.description);

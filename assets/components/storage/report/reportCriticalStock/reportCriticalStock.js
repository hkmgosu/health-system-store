(function() {
    ...
    /**
     * Example
     * <ssvq-report-critical-stock key=""></ssvq-report-critical-stock>
     */
    app.directive('ssvqReportCriticalStock', () => {
        return {
            ...
            restrict: 'E',
            scope: {},
            templateUrl: '/components/storage/report/reportCriticalStock/reportCriticalStock.html'
        };
    });
    ...
    function ComponentController($mdSidenav, $mdToast, storageReportFactory, productTypeFactory, unitProductsManagerFactory) {
        ...
        vm.getReportInit = () => {
            storageReportFactory.getCriticalStock({
        ...
        productTypeFactory.getList().then(
            res => {
                vm.productTypes = res.list;
            }
        );
        ...
        vm.getArrayXlsx = () => {
            ...
            arr[0] = ['Unidad', 'Tipo Producto', 'Producto', 'Código Producto', 'Stock Mínimo', 'Stock Anual'];
        ...
        vm.generateXLSX = () => {
            ...
            let filename = 'reporte_stock_critico_' + (moment().format('X')) + '.xlsx';
        ...
        vm.generatePdf = () => {
            ...
            }).download("reporte_stock_critico_" + (moment().format('X')) + ".pdf");
        };

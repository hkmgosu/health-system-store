(function() {
    ...
    /**
     * Example
     * <ssvq-report-max-stock key=""></ssvq-report-max-stock>
     */
    app.directive('ssvqReportMaxStock', () => {
        return {
            ...
            restrict: 'E',
            scope: {},
            templateUrl: '/components/storage/report/reportMaxStock/reportMaxStock.html'
        };
    });
    ...
    function ComponentController($mdSidenav, $mdDialog, $mdToast, storageReportFactory, productTypeFactory, unitProductsManagerFactory) {
        ...
        vm.getReportInit = () => {
            storageReportFactory.getMaxStock({
        ...
        vm.getArrayXlsx = () => {
            ...
            arr[0] = ['Unidad', 'Tipo Producto', 'Producto', 'Stock Máximo', 'Stock Anual'];
        ...
        vm.generateXLSX = () => {
            ...
            let filename = 'reporte_stock_maximo_' + (moment().format('X')) + '.xlsx';
        ...
        vm.generatePdf = () => {
            ...
            }).download("reporte_stock_maximo_" + (moment().format('X')) + ".pdf");
        };

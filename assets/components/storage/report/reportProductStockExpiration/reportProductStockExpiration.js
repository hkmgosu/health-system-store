(function() {
    ...
    /**
     * Example
     * <ssvq-report-product-stock-expiration key=""></ssvq-report-product-stock>
     */
    app.directive('ssvqReportProductStockExpiration', () => {
        return {
            ...
            restrict: 'E',
            scope: {},
            templateUrl: '/components/storage/report/reportProductStockExpiration/reportProductStockExpiration.html'
        };
    });
    ...
    function ComponentController($mdSidenav, $mdDialog, $mdToast, storageReportFactory, productTypeFactory, unitProductsManagerFactory) {
        ...
        vm.getReportInit = () => {
            storageReportFactory.getStockExpiration({
        ...
        vm.showCreatedAtFilter = ($event) => {
            $mdDialog.show({
                targetEvent: $event,
                templateUrl: '/components/storage/report/reportProductStockExpiration/rangeDate.html',
        ...
        vm.generateXLSX = () => {
            ...
            let filename = 'reporte_stock_por_vencimiento_' + (moment().format('X')) + '.xlsx';
        ...
        vm.generatePdf = () => {
            ...
            }).download("reporte_stock_por_vencimiento_" + (moment().format('X')) + ".pdf");
        };

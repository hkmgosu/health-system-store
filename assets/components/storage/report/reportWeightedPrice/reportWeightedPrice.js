(function() {
    ...
    /**
     * Example
     * <ssvq-weighted-price key=""></ssvq-weighted-price>
     */
    app.directive('ssvqReportWeightedPrice', () => {
        return {
            ...
            restrict: 'E',
            scope: {},
            templateUrl: '/components/storage/report/reportWeightedPrice/reportWeightedPrice.html'
        };
    });
    ...
    function ComponentController($mdSidenav, $mdToast, storageReportFactory, productTypeFactory, unitProductsManagerFactory) {
        ...
        vm.getArrayXlsx = () => {
            ...
            arr[0] = ['Tipo Producto', 'Lote', 'Cod Producto', 'Producto', 'Stock Actual', 'Precio Ponderado'];
        ...
        vm.generateXLSX = () => {
            ...
            let filename = 'reporte_precio_ponderado_' + (moment().format('X')) + '.xlsx';
        ...
        vm.getArrayFilter = () => {
            ...
            if (vm.filter.detailLot) {
                arr[count++] = vm.getBodyFilter('Detallado por Lote', '');
            }
        ...
        vm.generatePdf = () => {
            ...
            }).download("reporte_precio_ponderado_" + (moment().format('X')) + ".pdf");
        };

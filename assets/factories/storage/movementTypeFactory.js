(() => {
    'use strict';
    app.factory('movementTypeFactory', MovementTypeFactory);

    function MovementTypeFactory() {
        var urlBase = '/storage/movementType/';
        return {
            ...
            create: movementType => new Promise((resolve, reject) => {
            ...
            update: movementType => new Promise((resolve, reject) => {
